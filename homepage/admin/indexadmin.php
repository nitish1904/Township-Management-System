...
<section>
	...
	<main_content style="height: 400px;">
	<p><div class="news1" ><a class="news" href="news.php" style="text-align:left; border: 2px solid green; padding:3px; color:purple; text-decoration:none;"> >> News << </a></div></p>
...
while (($row = oci_fetch_assoc($stmt)) != false) {
    ...
    echo  "<p style =' color:red'>ALERT :  Due date has passed for your payment of Income Tax... Please pay ASAP </p>";
}
