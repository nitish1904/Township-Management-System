...
// }
$s = oci_parse($conn,
		"insert into Buy values ('$x1','$x2','$x3')");
...
oci_rollback($conn);
		...
		?>
		<br><br><br><br><br><br>
		<p style = "font-family: Times New Roman, Times, serif;text-align:center;font-size:30px ;"> Property has been bought successfully...</p>
	</main_content>
</section>
<footer>
	Copyright to 
