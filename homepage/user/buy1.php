				...
				<div class="col-md-4">
					<div class="thumbnail">
						...
						<div class="caption">
							...
							<form action="buy.php" method="get">
							<input class="input100" type="hidden" name="sellerid1" placeholder="sellerid1" value="C3">
				...
				<div class="col-md-4">
					<div class="thumbnail">
						...
						<div class="caption">
							...
							<form action="buy.php" method="get">
							<input class="input100" type="hidden" name="sellerid1" placeholder="sellerid1" value="C11">
				...
				<div class="col-md-4">
					<div class="thumbnail">
						<a>
							...
							<form action="buy.php" method="get">
							<input class="input100" type="hidden" name="sellerid1" placeholder="sellerid1" value="C7">
				...
				<div class="col-md-4">
					<div class="thumbnail">
						<a>
							...
							<form action="buy.php" method="get">
							<input class="input100" type="hidden" name="sellerid1" placeholder="sellerid1" value="C1">
				...
				<div class="col-md-4">
					<div class="thumbnail">
						<a>
							...
							<form action="buy.php" method="get">
							<input class="input100" type="hidden" name="sellerid1" placeholder="sellerid1" value="C4">
